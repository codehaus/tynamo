...
/**
 * Supplements the services defined by {@link org.tynamo.jpa.JPACoreModule} with additional
...
public class JPAModule {
    ...
    public static void contributeAlias(Configuration<AliasContribution> configuration, @JPACore EntityManager session) {
        configuration.add(AliasContribution.create(EntityManager.class, session));
    }
...
/*
    ...
    /**
     * Adds the CommitAfter annotation work, to process the {@link org.tynamo.jpa.annotations.CommitAfter}
     * annotation.
     */
    ...
    public static void contributeComponentClassResolver(Configuration<LibraryMapping> configuration) {
        configuration.add(new LibraryMapping("jpa", "eu.cuetech.tapestry.jpa"));
    }
