...
/**
 * Manages the JDO transaction for the current thread. This includes creating an persistence manager as
 * needed, allowing the pm to checkpoint (commit the current transaction and continue) and commit
