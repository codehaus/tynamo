...
/**
 * Responsible for creating an EntityManager as needed. Internally, is responsible for PersistenceUnit {@link
 * Configuration}, resulting in a {@link EntityManagerFactory}.
 * <p/>
...
public interface JPASessionSource {
    /**
