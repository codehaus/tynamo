...
package org.tynamo.jpa2.integration;
...
public class TapestryJPAIntegrationTests extends AbstractIntegrationTestSuite {
	public TapestryJPAIntegrationTests() {
		super("tapestry-jpa2/src/test/webapp");
	}
