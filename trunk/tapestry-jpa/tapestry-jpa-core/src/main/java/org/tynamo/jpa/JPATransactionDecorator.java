 ...
 * service methods marked by {@link org.apache.tapestry5.jpa.annotations.CommitAfter} the current
 * transaction is committed. Declared exceptions will also
 * {@linkplain org.apache.tapestry5.jpa.JPATransationManager#commit() commit the transaction};
 * runtime exceptions will {@linkplain org.apache.tapestry5.hibernate.JPATransationManager#abort()
 * the transaction}.
 * <p/>
 * It is recommended that you switch from the use of decoration to the use of advice; use the
 * {@link org.apache.tapestry5.hibernate.JPATransactionAdvisor} (from a service advisor method)
 * instead.
 */
