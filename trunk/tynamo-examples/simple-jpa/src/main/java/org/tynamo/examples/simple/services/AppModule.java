 ...
 */
@SubModule(value = {TynamoCoreModule.class, TynamoJpaModule.class, JpaModule.class})
public class AppModule
{
	...
	public static void provideSymbols(MappedConfiguration<String, String> configuration)
	{
		...
		configuration.add(TynamoJpaSymbols.ELASTICSEARCH_HOME, "/var/tynamo/examples-simple-jpa");
	}
