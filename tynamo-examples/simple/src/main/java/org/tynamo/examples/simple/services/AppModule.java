...
//		configuration.add(org.tynamo.examples.recipe.model.Recipe.class, new RecipeBuilder());
	...
	{
		configuration.add(PageType.LIST, org.tynamo.examples.simple.pages.List.class);
		configuration.add(PageType.SHOW, org.tynamo.examples.simple.pages.Show.class);
		configuration.add(PageType.ADD, org.tynamo.examples.simple.pages.Add.class);
		configuration.add(PageType.EDIT, org.tynamo.examples.simple.pages.Edit.class);
	}
